...
public class BaseTest2 {
	...
	private static final String SERVER_PWD="bestwiz";
    /**
     * 非切片客户端链接
     */
    private Jedis jedis;
    ...
    private void initialPool()
    {
        ...
        jedisPool = new JedisPool(config, SERVER_IP, 6379,2000,SERVER_PWD);
    ...
    private void initialShardedPool()
    {
        ...
        shards.add(new JedisShardInfo(SLAVE_IP, 6380));
...
//        shardedJedisPool.returnResource(shardedJedis);
    ...
    private void testKey()
    {
        ...
        jedis.get("abc");
        //slave 判断key否存在
        System.out.println(shardedJedis.exists("abc"));
        //error 
